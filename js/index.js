import { GamePhase, MouseEvent } from './consts/index.js';

// Game state
let phase = GamePhase.WAITING; // waiting | stretching | turning | walking | transitioning | falling
let lastTimestamp = undefined; // The timestamp of the previous animation cycle
...
window.addEventListener(MouseEvent.DOWN, function (event) {
...
window.addEventListener(MouseEvent.UP, function (event) {
